...
class LpkLoader():
    ...
    def check_decrypt(self, filename):
        ...
        try:
            ...
            if not success:
                ...
                manager.Log("steam workshop fileid is usually a foler under PATH_TO_YOUR_STEAM/steamapps/workshop/content/616720/([0-9]+)")
    ...
    def recovery(self, filename, output) -> Tuple[bytes, str]:
        ...
        manager.Log(f"[LPK Loader]: recovering {filename} -> {output+suffix}")
